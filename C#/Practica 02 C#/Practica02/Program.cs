...
//			PRUEBA DE FUNCIONAMIENTO DE CONJUNTO
//			Conjunto conjunto = new Conjunto();
//			llenarAlumnos(conjunto);
//			conjunto.agregar(new Alumno("", 20, 20, 10));
//			conjunto.agregar(new Alumno("", 20, 20, 10));
//			conjunto.agregar(new Alumno("", 20, 20, 10));
//			conjunto.agregar(new Alumno("", 300, 300, 100));
			...
			switch (opcion)
			{
				...
				case 3:
					...
					while (!legajoValido)
					{
						try
						{
							Console.WriteLine("\nIngrese el dato del alumno a consultar en la colección: ");
							int n = int.Parse(Console.ReadLine());
							Alumno alumBusq = new Alumno("Alumno", n, n, n);
							objBuscado = alumBusq;
							legajoValido = true;
						}
						catch (FormatException)
						{
							Console.WriteLine("\nError. Se produjo un error al ingresar el dato, intente de nuevo...\n");
						}
					}
					break;
			}
