...
namespace Practica04
{
	public class AlumnoDecoradoCalificacionEnLetras: AlumnoDecorator
	{
		...
		public AlumnoDecoradoCalificacionEnLetras(IAlumnoDecorable alumno): base(alumno)
		{
			this.alumno = alumno;
		}
		...
		public override string mostrarCalificacion()
		{
			...
			string mensaje = string.Format("{0}     {1}:{2}", alumno.getNombre(), calificacion, calificacionEnLetras);
			return mensaje;
		}
